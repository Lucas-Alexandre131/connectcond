...
$("#buttonGetShopTimes").on("click", function (e) {
    ...
    $.ajax({
        type: "GET",
        url: `https://connectcond-backend.onrender.com/shops/${shopId}/times`,
        contentType: "application/json",
        headers: {
            Authorization: `Bearer ${token}`
        },
...
$("#buttonUpdateTimes").on("click", function (e) {
    ...
    $.ajax({
        type: "PUT",
        url: `https://connectcond-backend.onrender.com/times/${id}`,
        contentType: "application/json",
        headers: {
            Authorization: `Bearer ${token}`
        },
...
$("#buttonDelleteTimes").on("click", function (e) {
    const token = getItem("authToken");
